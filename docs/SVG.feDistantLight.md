...
### Syntax
```PowerShell
SVG.feDistantLight [[-Content] <Object>] [-Azimuth <Object>] [-Elevation <Object>] [-Id <Object>] [-Lang <Object>] [-Tabindex <Object>] [-XmlBase <Object>] [-XmlLang <Object>] [-XmlSpace <Object>] [<CommonParameters>]
```
---
