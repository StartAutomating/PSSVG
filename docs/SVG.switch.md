...
#### **AllowReorder**
The allowReorder attribute.  See [MDN](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/allowReorder) for more information.
