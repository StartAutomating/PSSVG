...
#### **SVGattributecrossorigin**
The SVG attribute: crossorigin attribute.  See [MDN](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/SVG attribute: crossorigin) for more information.
