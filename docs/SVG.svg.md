...
#### **ZoomAndPan**
The zoomAndPan attribute.  See [MDN](https://developer.mozilla.org/en-US/docs/Web/SVG/Attribute/zoomAndPan) for more information.
