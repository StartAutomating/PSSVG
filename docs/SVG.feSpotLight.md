...
### Syntax
```PowerShell
SVG.feSpotLight [[-Content] <Object>] [-Data <IDictionary>] [-On <Object>] [-Attribute <IDictionary>] [-Comment <String>] [-Decorate <String>] [-Children <PSObject>] [-X <PSObject>] [-Y <PSObject>] [-Z <PSObject>] [-PointsAtX <PSObject>] [-PointsAtY <PSObject>] [-PointsAtZ <PSObject>] [-SpecularExponent <PSObject>] [-LimitingConeAngle <PSObject>] [-Id <PSObject>] [-Lang <PSObject>] [-Tabindex <PSObject>] [-XmlBase <PSObject>] [-XmlLang <PSObject>] [-XmlSpace <PSObject>] [<CommonParameters>]
```
