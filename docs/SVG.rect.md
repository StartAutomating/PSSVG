...
```PowerShell
Get-Module PSSVG | Split-Path | Join-Path -ChildPath Examples | Push-Location
./ManyRectangles.PSSVG.ps1 | Invoke-Item
Pop-Location
```
> EXAMPLE 17
...
#### **TextLength**
The textLength attribute.  See [MDN]() for more information.
