...
#### **Z**
The z attribute.  See [MDN]() for more information.
...
#### **Radius**
The radius attribute.  See [MDN]() for more information.
...
#### **Dx**
The dx attribute.  See [MDN]() for more information.
...
#### **PointsAtY**
The pointsAtY attribute.  See [MDN]() for more information.
...
#### **Dy**
The dy attribute.  See [MDN]() for more information.
...
#### **PointsAtZ**
The pointsAtZ attribute.  See [MDN]() for more information.
...
#### **Scale**
The scale attribute.  See [MDN]() for more information.
...
#### **In**
The in attribute.  See [MDN]() for more information.
...
#### **PointsAtX**
The pointsAtX attribute.  See [MDN]() for more information.
