...
### Syntax
```PowerShell
SVG.fePointLight [[-Content] <Object>] [-Data <IDictionary>] [-X <Object>] [-Y <Object>] [-Z <Object>] [-Id <Object>] [-Lang <Object>] [-Tabindex <Object>] [-XmlBase <Object>] [-XmlLang <Object>] [-XmlSpace <Object>] [<CommonParameters>]
```
---
